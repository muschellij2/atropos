...
setMethod(
  ...
  definition = function(x, i, j, ..., value) {
    ...
    return(.Call("antsImage_SetRegion", x, 
                 i, region, value, PACKAGE = "atropos"))
  }
)
...
setMethod(
  ...
  definition = function(x, i, j, ..., value) {
    ...
    return(.Call("antsImage_SetRegion", x, 
                 i$mask, i$region, value, PACKAGE = "atropos"))
  }
)
...
setMethod(
  ...
  definition = function(x, i, j, ..., value) {
    ...
    return(.Call("antsImage_SetRegion", 
                 x, mask, j, value, PACKAGE = "atropos"))
  }
)
